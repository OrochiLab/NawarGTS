			...
			<script src="${pageContext.request.contextPath}/vues/assets/vendor/bootstrap/js/bootstrap.js"></script>
			<script src="${pageContext.request.contextPath}/vues/assets/vendor/nanoscroller/nanoscroller.js"></script>
			<script src="${pageContext.request.contextPath}/vues/assets/vendor/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
			...
			<!-- Theme Custom -->
			<script src="${pageContext.request.contextPath}/vues/assets/javascripts/theme.custom.js"></script>
			
			<!-- Theme Initialization Files -->
			<script src="${pageContext.request.contextPath}/vues/assets/javascripts/theme.init.js"></script>
